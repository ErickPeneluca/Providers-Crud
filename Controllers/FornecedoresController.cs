...
namespace DivTech.Controllers
{
    public class FornecedoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,CNPJ,Specialty")] Fornecedor fornecedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,CNPJ,Specialty")] Fornecedor fornecedor)
        {
            if (id != fornecedor.Id)
            {
                return NotFound();
